    ...
    >
      ...
      <div className="p-3 flex items-start space-x-3 flex-1 min-w-0 overflow-hidden">
        {!isHorizontal && !hideUploader && (
          <img
            src={video.uploader?.avatar || "https://res.cloudinary.com/dby0edrrn/image/upload/v1749206416/man_1_fxzlur.png"}
            alt="avatar"
            className="w-10 h-10 rounded-full object-cover flex-shrink-0"
            onError={(e) => {
              e.target.onerror = null;
              e.target.src = "https://res.cloudinary.com/dby0edrrn/image/upload/v1749206416/man_1_fxzlur.png";
            }}
          />
